      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label for="area_name">Area Add</label>
                <input type="text" class="form-control area_name" name="area_name[]" placeholder="Area Name">
              </div>
            </div>
          </div>
    ...
    var html = "<div class='col-md-12 single_block'>";
      html += "<div class='row'>";
          html += "<div class='col-md-4'>";
              ...
              html += "<input type='text' class='form-control area_name' name='area_name[]' id='area_name' placeholder='Area Name'>";
              html += "</div>";
          html += "</div>";
