    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-11 mb-0">
          <h4 class="mb-0">Update Vendor</h4>
        </div>
        <div class="col-sm-1">
  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <form action="{{ url('vendor/update') }}" method="post" name="vendorForm" id="vendorForm" autocomplete="off">
          @csrf

          {{-- <input type="hidden" name="action" value="update"> --}}
          <input type="hidden" name="user_id" id="user_id" value="{{ $vendor_detail->user_id }}">
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              <label for="vendor_name">Vendor Name</label>
              <input type="text" class="form-control" name="vendor_name" id="vendor_name" value="{{ $vendor_detail->vendor_name }}">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="business_name" id="business_name" value="{{ $vendor_detail->business_name }}">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="mobile_number" id="mobile_number" maxlength="10"  value="{{ $vendor_detail->mobile }}">
              <div id="mobile_number_validate"></div>
              <div id="mobile_exist_validate" style="display: none; color: #eb0000; font-size: 15px; font-weight: normal !important;">Mobile number is already exist.</div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select class="form-control select2" name="state" style="width: 100%;" id="state">
                ...
                <?php foreach($data['state_data'] as $row){ ?>
                  <option value="<?php echo $row->state_id ?>" <?php echo ($row->state_id == $vendor_detail->state_id)? "selected" : "" ; ?>><?php echo $row->state_name ?></option>
                <?php } ?>
              </select>
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" name="city" style="width: 100%;" id="city">
                ...
                <?php foreach($data['city_data'] as $row){ ?>
                  <option value="<?php echo $row->city_id ?>" <?php echo ($row->city_id == $vendor_detail->city_id)? "selected" : "" ; ?>><?php echo $row->city_name ?></option>
                <?php } ?>
              </select>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="area" id="area" value="{{ $vendor_detail->area }}">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="pin_code" id="pin_code" maxlength="6"  value="{{ $vendor_detail->pin_code }}">
          ...
          {{-- <div class="col-md-4">
            <div class="form-group">
                ...
                <select class="form-control" name="vendor_type" style="width: 100%;" id="vendor_type">
                    ...
                    <option value="<?php // echo $row->vendor_type_id; ?>" <?php // echo ($row->vendor_type_id == $vendor_detail->vendor_type_id)? "selected" : "" ; ?>><?php // echo $row->vendor_type_name; ?></option>
                    <?php // } ?>
                </select>
...
function checkMobileExist(form){
  ...
  $.ajax({
        ...
        "data": {"user_id":user_id, "mobile_number": mobile_number},
        "type": "POST",
        beforeSend: function(){
            $('#please_wait_loading').show();
        },
